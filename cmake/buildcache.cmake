...
set(buildcache-bin ${CMAKE_CURRENT_BINARY_DIR}/bin/buildcache)
...
elseif (rule-launch-set)
  ...
  find_program(buildcache_program buildcache HINTS ${CMAKE_CURRENT_BINARY_DIR}/bin)
  if (buildcache_program)
    ...
    elseif (UNIX)
      set(buildcache-archive "buildcache-linux.zip")
    elseif (WIN32)
    ...
    set(buildcache-url "https://github.com/mbitsnbites/buildcache/releases/download/v0.19.1/${buildcache-archive}")
